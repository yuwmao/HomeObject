...
private:
    ...
    void on_replace_member_ctx_meta_blk_found(homestore::meta_blk* mblk, sisl::byte_view buf);
    void on_replace_member_ctx_meta_blk_recover_completed(bool success);
