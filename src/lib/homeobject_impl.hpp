...
public:
    ...
    PGManager::NullAsyncResult start_replace_member(pg_id_t id, peer_id_t const& old_member, PGMember& new_member,
                                                    u_int32_t commit_quorum, trace_id_t trace_id) final;
    PGManager::NullAsyncResult complete_replace_member(pg_id_t id, peer_id_t const& old_member,
                                                       PGMember& new_member, u_int32_t commit_quorum,
